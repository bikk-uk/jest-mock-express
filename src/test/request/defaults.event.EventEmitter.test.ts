...
describe('request - Defaults from "event.EventEmitter" (accepts no arguments and return default values)', () => {
  ...
  test('req.off is a mocked function', () => {
    ...
    expect((req.off as jest.Mock).getMockName()).toBe('off mock default')
  })
  ...
  test('req.removeAllListeners is a mocked function', () => {
    ...
    expect((req.removeAllListeners as jest.Mock).getMockName()).toBe('removeAllListeners mock default')
  })
  ...
  test('req.setMaxListeners is a mocked function', () => {
    ...
    expect((req.setMaxListeners as jest.Mock).getMockName()).toBe('setMaxListeners mock default')
  })
  ...
  test('req.getMaxListeners is a mocked function', () => {
    ...
    expect((req.getMaxListeners as jest.Mock).getMockName()).toBe('getMaxListeners mock default')
  })
  ...
  test('req.listeners is a mocked function', () => {
    ...
    expect((req.listeners as jest.Mock).getMockName()).toBe('listeners mock default')
  })
  ...
  test('req.rawListeners is a mocked function', () => {
    ...
    expect((req.rawListeners as jest.Mock).getMockName()).toBe('rawListeners mock default')
  })
  ...
  test('req.listenerCount is a mocked function', () => {
    ...
    expect((req.listenerCount as jest.Mock).getMockName()).toBe('listenerCount mock default')
  })
  ...
  test('req.eventNames is a mocked function', () => {
    ...
    expect((req.eventNames as jest.Mock).getMockName()).toBe('eventNames mock default')
  })
})
